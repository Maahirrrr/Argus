        ...
        <div className="space-y-1.5">
          {events.map((ev) => (
            <div
              ...
              className="flex items-center justify-between p-2 rounded-[4px] bg-[#0C0C0C] hover:bg-[#121212] border border-[rgba(255,255,255,0.04)] cursor-pointer transition-colors"
            >
              ...
              <span
                className={`text-[10px] font-mono-tech font-bold px-1 py-0.5 rounded-[2px] ${
                  ev.status === 'critical' ? 'text-[#E5484D] bg-[#EF4444]/10' : 'text-[#F5A524] bg-[#F59E0B]/10'
                }`}
              >
                {ev.delta}
              </span>
